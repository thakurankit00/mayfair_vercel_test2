...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  const getNavigationItems = () => {
    ...
    // Waiter Interface - for waiters, managers, and admins
    if (hasAnyRole(['waiter', 'manager', 'admin'])) {
      items.push({
        name: 'Waiter Interface',
        path: '/waiter',
        icon: (
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 0h.01M9 16h.01" />
          </svg>
        ),
    ...
    // Kitchen Dashboard - for chefs, bartenders, managers, and admins
    if (hasAnyRole(['chef', 'bartender', 'manager', 'admin'])) {
      items.push({
        name: 'Kitchen',
        path: '/kitchen',
        icon: (
        ...
        roles: ['chef', 'bartender', 'manager', 'admin']
      });
    }
    ...
    // Booking Calendar - for receptionists, managers, and admins only
    if (hasAnyRole(['receptionist', 'manager', 'admin'])) {
      items.push({
